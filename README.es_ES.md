...
Para la documentación completa, visita la [Wiki del proyecto](https://github.com/ifwqu/3x-ui/wiki).
...
[![Stargazers over time](https://starchart.cc/ifwqu/3x-ui.svg?variant=adaptive)](https://starchart.cc/ifwqu/3x-ui)
